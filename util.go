...
// SetTableName allows to set up table name manually.
// Usefull when autogenerated name doesn't suite db naming.
func SetTableName(structPtr interface{}, name string) {
